    ...
    <article class="panel form-panel {{ in_array($resource, ['products', 'categories'], true) ? 'form-panel-full' : '' }}">
        <form action="{{ $isEdit ? route('backend.resource.update', ['resource' => $resource, 'id' => $record->id]) : route('backend.resource.store', ['resource' => $resource]) }}" method="POST" class="admin-form" enctype="multipart/form-data">
            ...
            @if ($resource === 'products')
                <div class="product-form-layout">
                    <section class="form-section form-section-main">
                        <div class="form-section-head"><span>01</span><h2>Product Details</h2></div>
                        <div class="form-grid product-core-grid">
                    ...
                    <section class="form-section">
                        <div class="form-section-head"><span>02</span><h2>Pricing &amp; Status</h2></div>
                        <div class="form-grid product-side-grid">
                            <label>Price
                    ...
                    <section class="form-section form-section-main">
                        <div class="form-section-head"><span>03</span><h2>Media</h2></div>
                    ...
                    <section class="form-section form-section-main">
                        <div class="form-section-head"><span>04</span><h2>Description</h2></div>
                        <label class="rich-field">Description
            ...
            @elseif ($resource === 'categories')
                <div class="product-form-layout">
                    <section class="form-section form-section-main">
                        <div class="form-section-head"><span>01</span><h2>Category Details</h2></div>
                        <div class="form-grid product-core-grid">
                    ...
                    <section class="form-section">
                        <div class="form-section-head"><span>02</span><h2>Media</h2></div>
                        <div class="form-grid product-side-grid">
                            <label>Upload Image
                                <input type="file" name="image_file" accept="image/png,image/jpeg,image/webp">
                                @error('image_file')<span>{{ $message }}</span>@enderror
                    ...
                    <section class="form-section form-section-main">
                        <div class="form-section-head"><span>03</span><h2>Description</h2></div>
                        <label class="rich-field">Description
                            <textarea class="rich-text-source" name="description" rows="4" data-rich-text>{{ old('description', $record->description ?? '') }}</textarea>
                        </label>
                    </section>
            ...
            @elseif ($resource === 'reviews')
                <div class="product-form-layout">
                    <section class="form-section form-section-main">
                        <div class="form-section-head"><span>01</span><h2>Customer Review</h2></div>
                        <div class="form-grid product-core-grid">
                    ...
                    <section class="form-section">
                        <div class="form-section-head"><span>02</span><h2>Linking</h2></div>
                        <div class="form-grid product-side-grid">
                    ...
                    <section class="form-section form-section-main">
                        <div class="form-section-head"><span>03</span><h2>Review Text</h2></div>
                        <label>Review
            ...
            @else
                <div class="product-form-layout">
                    <section class="form-section form-section-main">
                        <div class="form-section-head"><span>01</span><h2>User Details</h2></div>
                        <div class="form-grid product-core-grid">
                            <label class="field-medium">Name
                                <input name="name" value="{{ old('name', $record->name ?? '') }}" required>
                                @error('name')<span>{{ $message }}</span>@enderror
                    ...
                    <section class="form-section">
                        <div class="form-section-head"><span>02</span><h2>Access</h2></div>
                        <div class="form-grid product-side-grid">
                            <label>Role
