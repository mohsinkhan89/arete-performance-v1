...
@php
  ...
  $hasCalculator = str_contains($categoryIdentity, 'peptide') || str_contains($categoryIdentity, 'injectable');
  $calculatorUrl = $hasCalculator ? route('frontend.peptide-calculator', $product->slug) : null;
@endphp
    ...
    <div class="container">
      ...
      <article class="product-info-card tab-content-card" id="description" data-tab-card="description">
        <nav class="product-tabs" aria-label="Description tab">
          <a class="active" href="#description">Description</a><a href="#benefits">Benefits</a><a href="#dosage">Dosage</a><a href="#ingredients">Ingredients</a><a href="#reviews">Reviews</a><a href="#faq">FAQ</a>@if($hasCalculator)<a href="{{ $calculatorUrl }}" data-external-tab>Calculator</a>@endif
        </nav>
      ...
      <article class="product-info-card tab-content-card" id="benefits" data-tab-card="benefits">
        <nav class="product-tabs" aria-label="Benefits tab">
          <a href="#description">Description</a><a class="active" href="#benefits">Benefits</a><a href="#dosage">Dosage</a><a href="#ingredients">Ingredients</a><a href="#reviews">Reviews</a><a href="#faq">FAQ</a>@if($hasCalculator)<a href="{{ $calculatorUrl }}" data-external-tab>Calculator</a>@endif
        </nav>
      ...
      <article class="product-info-card tab-content-card" id="dosage" data-tab-card="dosage">
        <nav class="product-tabs" aria-label="Dosage tab">
          <a href="#description">Description</a><a href="#benefits">Benefits</a><a class="active" href="#dosage">Dosage</a><a href="#ingredients">Ingredients</a><a href="#reviews">Reviews</a><a href="#faq">FAQ</a>@if($hasCalculator)<a href="{{ $calculatorUrl }}" data-external-tab>Calculator</a>@endif
        </nav>
      ...
      <article class="product-info-card tab-content-card" id="ingredients" data-tab-card="ingredients">
        <nav class="product-tabs" aria-label="Ingredients tab">
          <a href="#description">Description</a><a href="#benefits">Benefits</a><a href="#dosage">Dosage</a><a class="active" href="#ingredients">Ingredients</a><a href="#reviews">Reviews</a><a href="#faq">FAQ</a>@if($hasCalculator)<a href="{{ $calculatorUrl }}" data-external-tab>Calculator</a>@endif
        </nav>
      ...
      <article class="product-info-card tab-content-card" id="reviews" data-tab-card="reviews" data-server-content="{{ $reviews->isNotEmpty() ? '1' : '0' }}">
        <nav class="product-tabs" aria-label="Reviews tab">
          <a href="#description">Description</a><a href="#benefits">Benefits</a><a href="#dosage">Dosage</a><a href="#ingredients">Ingredients</a><a class="active" href="#reviews">Reviews</a><a href="#faq">FAQ</a>@if($hasCalculator)<a href="{{ $calculatorUrl }}" data-external-tab>Calculator</a>@endif
        </nav>
      ...
      <article class="product-info-card tab-content-card" id="faq" data-tab-card="faq">
        <nav class="product-tabs" aria-label="FAQ tab">
          <a href="#description">Description</a><a href="#benefits">Benefits</a><a href="#dosage">Dosage</a><a href="#ingredients">Ingredients</a><a href="#reviews">Reviews</a><a class="active" href="#faq">FAQ</a>@if($hasCalculator)<a href="{{ $calculatorUrl }}" data-external-tab>Calculator</a>@endif
        </nav>
